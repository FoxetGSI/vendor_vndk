...
7z x -y $thispath/11/com.android.vndk.v28.apex.7z -o$systempath/system_ext/apex/ -bso0 -bsp0
7z x -y $thispath/11/com.android.vndk.v29.apex.7z -o$systempath/system_ext/apex/ -bso0 -bsp0
